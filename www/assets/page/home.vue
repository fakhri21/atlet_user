...
<!-- Content Header (Page header) -->
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <b-row>
            <div>
                <b-carousel controls id="carousel-fade" style="text-shadow: 0px 0px 2px #000" fade indicators img-width="1024"
                    img-height="90px">
                    <b-carousel-slide caption="Resepsionis" img-src="img/resepsionis.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Lobi Utama" img-src="img/main_lobby.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Kolam Renang" img-src="img/kolam_renang.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Kamar VIP" img-src="img/1.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Kamar Reguler" img-src="img/2.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Fasilitas Kamar" img-src="img/3.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Fasilitas Kamar" img-src="img/4.jpeg">
                    </b-carousel-slide>
                    <b-carousel-slide caption="Fasilitas Kamar" img-src="img/5.jpeg">
                    </b-carousel-slide>
                </b-carousel>
            </div>
          </b-row>
